    ...
    return (
        <div className="pl-4 pr-4 pt-2 mb-5 w-full">
            <div className="bg-white pl-5 pr-5 pt-2 pb-5 w-full flex lg:items-center flex-col rounded-lg shadow-md shadow-black">
                ...
                <div className="hidden lg:block font-bold text-2xl w-full text-center mt-3 mb-3">
                    LESSON TODAY
                </div>
                <div className='lg:w-5/6'>
                    <h1 className="font-bold text-2xl">{lessonOfTheDay.name || 'Lesson Today'}</h1>
                    <p className="text-lg">{lessonOfTheDay.description || 'No description available.'}</p>
                    <h2 className="mt-4 font-semibold text-xl">Objective:</h2>
                    <li>{lessonOfTheDay.objective || 'No objectives provided.'}</li>
                    <div className="mt-4">
                        <h1 className="font-semibold">Content</h1>
                        <p>{lessonOfTheDay.content || 'No content available.'}</p>
                    </div>
                </div>
                ...
                <div className="mt-5 pl-5 pr-5">
                    {lessonOfTheDay.download && (
                        <a
                            ...
                            download
                            className="bg-emerald-700 p-1 flex items-center justify-center rounded-lg h-10 w-full lg:h-16 lg:mt-9"
                        >
